...
class ParametersInspectorTest {
    ...
    private void assertException(String[] input, String expected) {
        ParametersInspector parametersInspector = new ParametersInspector();

        try {
            parametersInspector.inspect(input);
    ...
    @Test
    void runTest10() {
        String[] input = {"a=1", "b=2", "b=3"};
        String expected = "Input parameters list contains a redundant element \"b\".";
